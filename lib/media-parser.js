...
var MediaParser, MediaParserUtils, MediaServices, MediaTypes, NodeHttpService, e1, e2;
...
MediaParser = {
  ...
  allURLs: function(content) {
    return content.match(MediaParser.url_pattern) || [];
  }
};
...
MediaServices = {
  ...
  parseDeviantArt: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.DevaiantArt, 'https://backend.deviantart.com/oembed?url={0}&format=json', timeout, 'image');
  },
  parseHulu: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Hulu, 'http://www.hulu.com/api/oembed?url={0}&format=json', timeout, 'video');
  },
  parseJustin: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.JustinTv, 'http://api.justin.tv/api/embed/from_url.json?url={0}', timeout, 'video');
  },
  parseScreenr: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Screenr, "http://www.screenr.com/api/oembed.json?url={0}", timeout, 'video');
  },
  parseRdio: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Rdio, "http://www.rdio.com/api/oembed/?url={0}&format=json", timeout, 'audio');
  },
  parseSoundCloud: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Soundcloud, "https://soundcloud.com/oembed?url={0}&format=json", timeout, 'audio');
  },
  parseSpotify: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Spotify, "https://embed.spotify.com/oembed/?url={0}&format=json", timeout, 'audio');
  },
  parseTed: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Ted, "http://www.ted.com/talks/oembed.json?url={0}", timeout, 'video');
  },
  ...
  parseYoutube: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Youtube, "http://www.youtube.com/oembed?url={0}&format=json", timeout, 'video');
  }
};
...
MediaTypes = {
  ...
  genericOemebed: function(cnt, callback, reg_exp, oembed_template, timeout, underlying_type) {
    var match;
...
NodeHttpService = {
  oembedRequest: function(url, callback_ok, callback_error, content_url, timeout) {
    ...
    return needle.get(url, args, function(error, response) {
      var body, e, json;
