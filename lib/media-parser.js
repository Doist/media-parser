...
var GWebHttpService, MediaParser, MediaParserUtils, MediaServices, MediaTypes, NodeHttpService, e, e1,
...
MediaServices = {
  ...
  parseDeviantArt: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.DevaiantArt, 'https://backend.deviantart.com/oembed?url={0}&format=json', 'image', timeout);
  },
  parseHulu: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Hulu, 'http://www.hulu.com/api/oembed?url={0}&format=json', 'video', timeout);
  },
  parseJustin: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.JustinTv, 'http://api.justin.tv/api/embed/from_url.json?url={0}', 'video', timeout);
  },
  parseScreenr: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Screenr, "http://www.screenr.com/api/oembed.json?url={0}", 'video', timeout);
  },
  parseRdio: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Rdio, "http://www.rdio.com/api/oembed/?url={0}&format=json", 'audio', timeout);
  },
  parseSoundCloud: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Soundcloud, "https://soundcloud.com/oembed?url={0}&format=json", 'audio', timeout);
  },
  parseSpotify: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Spotify, "https://embed.spotify.com/oembed/?url={0}&format=json", 'audio', timeout);
  },
  parseTed: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Ted, "http://www.ted.com/talks/oembed.json?url={0}", 'video', timeout);
  },
  ...
  parseYoutube: function(cnt, callback, timeout) {
    return MediaTypes.genericOemebed(cnt, callback, MediaServices.providers.Youtube, "http://www.youtube.com/oembed?url={0}&format=json", 'video', timeout);
  }
};
...
MediaTypes = {
  ...
  genericOemebed: function(cnt, callback, reg_exp, oembed_template, media_type, timeout) {
    var match;
  ...
  oembedImageEntitiy: function(callback, opts) {
    ...
    cb_ok = function(json) {
      var result;
      result = {
        'content_url': json.url || content_url,
        'get_thumbnail_url': function(size) {
...
GWebHttpService = (function() {
  ...
  GWebHttpService.prototype.oembedRequest = function(url, ok_callback, error_callback, content_url) {
    ...
    callback = this[callback_id] = (function(_this) {
